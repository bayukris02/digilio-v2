...
class PurchaseOrderLine(BaseModel):
    ...
    _fields = {
        ...
        'purchase_request_line': Many2OneField(
            label='Baris Permintaan Pembelian',
        ...
        'done_qty': FloatField(label='Qty Diterima', default=0, virtual=True, hidden_statuses=['draft']),
        'in_receipt_qty': FloatField(label='Qty Dalam Penerimaan', default=0, virtual=True, hidden_statuses=['draft']),
        'remaining_qty': FloatField(label='Qty Sisa', default=0, virtual=True, hidden_statuses=['draft']),
        'billed_qty': FloatField(label='Qty Ditagih', default=0, virtual=True, hidden_statuses=['draft']),
    ...
    _list_view = {
        'columns': ['product', 'name', 'qty', 'uom', 'done_qty', 'in_receipt_qty', 'remaining_qty', 'price', 'discount_percentage', 'discount_amount', 'taxes', 'tax_amount', 'total'],
        'default_sort': ['id'],
    }
