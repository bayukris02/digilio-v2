...
class PurchaseOrder(BaseModel):
    ...
    _fields = {
        ...
        'category': SelectionField(
            label='Kategori',
            options=['Bahan Baku', 'Barang Jadi', 'Jasa', 'Aset'],
        ),
        ...
        'is_active': BooleanField(label='Aktif', default=True, chatter_show=False),
        # ── Summary fields ──
        ...
        'bill_method': SelectionField(
            ...
            options=[('on_order', 'Saat Pesanan'), ('on_receipt', 'Saat Penerimaan')],
            default=None,
        ...
        'notebook': [
            {
                ...
                'label': 'Baris Pesanan',
                'relation': 'order_lines',
                'columns': ['product', 'name', 'qty', 'uom', 'price', 'pricelist_price', 'discount_percentage', 'discount_amount', 'taxes', 'tax_amount', 'total'],
                'summary': {
            ...
            if dp_mode == 'percentage':
                ...
                with transaction.atomic():
                    ...
                    for (tax_ids, disc_pct), data in groups.items():
                        ...
                        label = ', '.join(parts)
                        dp_line = VendorBillLine.objects.create(
                            bill_id=bill,
                            name=label,
                            qty=1,
                            price=price,
